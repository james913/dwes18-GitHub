...
public class MostrarAnimalesServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
		  ...
		  //CÓDIGO DE MENSAJE SI NO MUESTRA NINGÚN RESULTADO:
		 /* if (!rset.next()) { // MALA SOLUCIÓN
		  ...
		  out.println("<table  bgcolor='cyan'><tr><th>NOMBRE</th><th>ESPECIE</th><th>IMAGEN</th></tr>");
		  while (rset.next()) {
			  
			  out.println("<tr bgcolor='cyan'>");
			  out.println("<td>"+ rset.getString("nombre") +"</td>");
			  out.println("<td>"+rset.getString("especie")+"</td>");
			 out.println("<td><img src="+imagen+rset.getString("imagen")+"></td>");
